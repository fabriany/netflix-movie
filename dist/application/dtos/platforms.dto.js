...
], CreatePlatformDto.prototype, "icon", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
...
], CreatePlatformDto.prototype, "createdAt", void 0);
__decorate([
    (0, class_validator_1.IsDate)(),
    (0, class_transformer_1.Type)(() => Date),
    __metadata("design:type", Date)
], CreatePlatformDto.prototype, "updatedAt", void 0);
exports.CreatePlatformDto = CreatePlatformDto;
class UpdatePlatformDto extends (0, swagger_1.PartialType)(CreatePlatformDto) {
    static _OPENAPI_METADATA_FACTORY() {
        return {};
    }
}
